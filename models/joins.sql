...
ordrs as (
select ord.order_id, ord.order_date, cs.company_name as customer,  em.name as employee, em.age, em.lengthofservice
...
finajoin as (
select od.*, ord.order_date, ord.employee, ord.age, ord.lengthofservice
from orddetai od
inner join ordrs ord on od.order_id=ord.order_id

)
select * from finajoin
